...
exports.googleImagesFields = void 0;
const SerpApiDescription_1 = require("./SerpApiDescription");
const GoogleOptions_1 = require("./GoogleOptions");
exports.googleImagesFields = [
    {
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                type: 'options',
                options: GoogleOptions_1.DomainOptions,
            },
            {
                ...
                type: 'options',
                options: GoogleOptions_1.CountryOptions,
            },
            {
                ...
                type: 'options',
                options: GoogleOptions_1.LanguageOptions,
            },
            {
                displayName: 'Set Multiple Countries (cr)',
                name: 'cr',
                description: 'Parameter defines one or multiple countries to limit the search to. It uses country{two-letter upper-case country code} to specify countries and | as a delimiter. (e.g., countryFR|countryDE).',
                default: '',
                routing: {
                    request: {
                        qs: {
            ...
            },
            {
                ...
                name: 'as_qdr',
                description: 'Parameter requests search results from a specified time period (quick date range). See documentation for supported values: https://serpapi.com/advanced-google-query-parameters#api-parameters-advanced-search-query-parameters-as-qdr.',
                default: '',
                routing: {
                    request: {
                        qs: {
            ...
            },
            {
                ...
                name: 'period_unit',
                description: "Parameter defines the time period unit to search for the recent images, e.g. from past minute, hour, day etc. This parameter can't be used with start_date/end_date parameters. This parameter overrides qdr component of tbs parameter.",
                default: 'y',
                routing: {
                    request: {
                        qs: {
            ...
            },
            {
                ...
                name: 'period_value',
                description: 'Parameter defines an optional time period value that can be used with period_unit to describe time periods like 15 seconds, 42 hours, 178 days etc. Default value: 1. Value range: 1..2147483647.',
                default: '',
                routing: {
                    request: {
                        qs: {
            ...
            },
            {
                ...
                name: 'image_color',
                description: 'Parameter defines the color of images. This parameter overrides ic and isc components of tbs parameter.',
                default: 'bw',
                routing: {
                    request: {
                        qs: {
            ...
            },
            {
                ...
                name: 'image_type',
                description: 'Parameter defines the type of images. This parameter overrides itp component of tbs parameter.',
                default: 'photo',
                routing: {
                    request: {
                        qs: {
            ...
            },
            {
                ...
                name: 'licenses',
                description: 'Parameter defines the scope of licenses of images. This parameter overrides sur component of tbs parameter.',
                default: 'f',
                routing: {
                    request: {
                        qs: {
            ...
            },
            {
                ...
                name: 'filter',
                description: "Whether the filters for 'Similar Results' and 'Omitted Results' are on or off. It can be set to true (default) to enable these filters, or false to disable these filters.",
                default: true,
                routing: {
                    request: {
                        qs: {
            ...
            },
            {
                ...
                name: 'ijn',
                description: 'Parameter defines the page number for Google Images. There are 100 images per page. This parameter is equivalent to start (offset) = ijn * 100.',
                default: '',
                routing: {
                    request: {
                        qs: {
            ...
            ...SerpApiDescription_1.serpApiFields,
        ],
    },
];
//# sourceMappingURL=GoogleImagesDescription.js.map